...
def final_grade(grade_input):

    grade_result = -1 # The default error value

    # Calculate the zero place rounded value
    grade_round = round(grade_input)

    # Select the Grade Point Average value in logic tree
    if grade_round > 100:
        pass
    ...
    # Return the computed value to the calling code
    return grade_result


print(f"GPA Calculator\n")
grade_string = input("Enter grade value: ")

grade_display = final_grade(float(grade_string))

print(f"The GPA Value for input of {grade_string} is {grade_display}\n\n")
