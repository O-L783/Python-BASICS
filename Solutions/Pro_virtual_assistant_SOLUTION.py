...
# of interactive Virtual Assistants are now making this dream
# a reality.  In this exercise you will develop a program which
# can carry out a very rudimentary form of "conversation".  For
# example, here's a conversation in which each of the computer's
# prompts on the left is followed by the user's responses on
# the right:
#
#    Hello, I'm your Virtual Assistant. G'day.
...
# I'm your Virtual Assistant."  This will allow the program to carry
# out a "conversation" with the user (but one which will get boring
...
#---------------------------------------------------------
# These are the tests your "respond" function must pass.
#
""" 
...
>>> respond("I don't know how this works.")
'What do you mean?'
...
users_input = input("Hello, I'm your Virtual Assistant. ")
# Repeatedly reply to the user a certain number of times
for reply in range(5):
    # Decide what the Virtual Assistant should say next
    assistants_output = respond(users_input)
    # Get the next input from the user
    users_input = input(assistants_output + " ")
