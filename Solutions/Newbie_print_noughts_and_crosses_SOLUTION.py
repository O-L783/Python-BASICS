...
##### PUT YOUR CODE HERE
all_cells = game3a + game3b + game3c
...
for position in positions:
    print(game1[position][position], end = '')
print()
...
##### PUT YOUR CODE HERE
for column_num in [0, 1, 2]:
    print(game4a[column_num], end = '')
    print(game4b[column_num], end = '')
    print(game4c[column_num], end = '')
print()
