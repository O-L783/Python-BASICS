...
# A function to return 50 if all argument
# values are the same, otherwise return 0.
#
def yahtzee(die1, die2, die3, die4, die5):

    YAHTZEE = 50  # constant for "yahtzee" score

    if die1 == die2 == die3 == die4 == die5:
        # Alternative: if die1 == die2 and die2 == die3 and die3 == die4 and die4 == die5:       
        return YAHTZEE # We have a "yahtzee"!
    else:
        
        return 0 # Values are not all the same - no yahtzee
