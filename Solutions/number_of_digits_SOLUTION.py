...
# of 366 pages.  Write a Python expression to calculate how
# many individual digits you have to write down.  (NB: You are
# not expected to write "leading zeros" on the page numbers.)
#
...
num_one_digit_pages = (9 - 1) + 1  # Pages 1 to 9
num_two_digit_pages = (99 - 10) + 1 # Pages 10 to 99
num_three_digit_pages = (366 - 100) + 1 # Pages 100 to 366
