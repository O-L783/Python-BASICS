...
# Print a welcome message for a club where Queenslanders who live far 
# enough get a complimentary drink (loosely based on an example
# in Section 3.2.2 of the textbook "Python for Rookies")
#
def print_welcome(distance, state):
    # Types: "distance" is a natural number and "state" is a string
    # with two possible values, 'QLD' and 'NSW'
    if distance >= 50 and state == 'QLD':
