...
# However, you can control the sequence of random values
# produced by starting with a fixed "seed" value

from random import seed
seed(5)
print('Starting with seed 5 the first random two-digit number is', randint(10, 99))
print('And the second random two-digit number is', randint(10, 99))
seed(5)
print('After resetting with the same seed the first "random" two-digit number is', randint(10, 99))
print('And the next "random" two-digit number is', randint(10, 99))
print()
...
seed(None) # reset the seed to its random default
