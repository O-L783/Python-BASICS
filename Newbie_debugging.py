...
def is_consonant(char):
    if char.isalpha():
        if not (char in "aeiou" and char in "AEIOU"):
            return True
    else:
            return False
...
print(is_consonant("A")) # should print True
print(is_consonant("e")) # should print True
print(is_consonant("O")) # should print True
